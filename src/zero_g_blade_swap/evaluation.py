...
# Which solved axial reset station produced the episode. Optional so archived
# rows remain loadable by name and non-insertion tasks keep their schema.
RESET_STATION_FIELD = "reset_station"
