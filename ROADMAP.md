...
| Release | Three maintained documents, pinned setup/commands, immutable negative evidence, plots and CPU/source-only verification in `evidence/cable_cycle_verification_v1.json`. Verified 19.5 s saved-state video in `evidence/cable_video_v1.json`; zero new integration steps, research decision unchanged. |
