"""Registered uniform PPO with v3 completion credit; fresh training and budget-only evaluation."""
...
def main():
    ...
    report = {"status": "starting", "mode": args.mode, "seed": args.seed, "cohorts": [],
              "controller": "project_uniform_fault_ppo_completion_credit_v3", "research_result": False, "reward_version": "completion_credit_v3",
        ...
        for cohort in range(args.cohorts):
            ...
            if model is None:
                ...
                if training:
                    ...
                    if loaded["status"] != "budget_complete" or loaded["spec"] != model.spec or loaded.get("reward_version") != "completion_credit_v3":
            ...
            if training:
                ...
                checkpoint = {"status": "budget_complete" if final else "partial", "model": model.state_dict(),
                              ...
                              "reward_version": "completion_credit_v3",
