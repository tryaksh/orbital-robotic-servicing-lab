"""Conditional fixed480Hz-servo scripted-prefix diagnostic; no training or final tests."""
...
def main():
    ...
    report = {"status": "starting", "controller": args.controller, "seed": args.seed,
               "research_result": False, "reward_version": "completion_credit_v3", "diagnostic_protocol": "servo_impact_v1", "mode": args.mode, "refinement": args.refinement, "training_run_status": "completed", "checkpoint_selection": "Final registered 22-cohort budget checkpoint; no selection by score"}
    report["controller_condition"] = {
        ...
        "change": "Only external impedance-servo commands recompute at480Hz. Native physics480/960Hz, gains, clamps, targets, implicit gripper and120Hz sensor/noise path stay unchanged.",
    }
    app = env = None
    try:
        ...
        env = PegServoImpactEnvV1(cfg, criteria=criteria, cases=cases, nominal=study["fault_support"]["nominal"], audit=True, refinement=args.refinement)
        ...
        report.update(
            ...
            scope_and_limitations=[
                ...
                "This is the prospective external-servo cause test; compare both480/960Hz native resolutions with their unchanged120Hz-servo references before attributing an effect. No model fitting, gain tuning or claimed robustness follows from one resolution.",
