"""Evaluate the frozen uniform pilot on the three declared development seeds."""
...
def main():
    ...
    for seed in (10070, 10071, 10072):
        ...
        command = [sys.executable, str(ROOT / "scripts/run_uniform.py"), "evaluate", "--run-id", run_id,
