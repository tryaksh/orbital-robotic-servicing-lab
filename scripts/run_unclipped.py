...
def main():
    ...
    command = [str(args.sim_python), str(ROOT / "scripts/train_unclipped.py"), "--headless", "--output", str(output / "pilot"),
    ...
    manifest = {"schema": 1, "status": "starting", "run_id": run_id, "research_result": False,
                ...
                "scope": "Fresh registered uniform reward-v3/value-unclipped-v4 development run; final-budget evaluation only, no adaptive comparison or final test."}
