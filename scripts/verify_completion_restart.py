...
def main():
    ...
    for p in args.evaluation:
        ...
        frozen = json.loads((ROOT / "configs/protocol_v3_restart_v1.json").read_text())
    ...
    result["prior_development_costs"] = json.loads((ROOT / "configs/completion_training_restart_v1.json").read_text())["previous_cost_accounting"]
