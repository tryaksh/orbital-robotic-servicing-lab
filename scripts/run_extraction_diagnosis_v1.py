...
def main():
    ...
    checkpoint = ROOT / "artifacts/assembly/uniform_completion_170_v3_r01/pilot/budget_checkpoint.pt"
    registration = ROOT / "configs/extraction_diagnosis_v1.json"
    ...
    evaluation = json.loads((ROOT / "evidence/uniform_completion_v3.json").read_text())
    ...
    for controller in ("deterministic", "stochastic", "clipped_mean", "retry"):
        ...
        command = ["C:/isaac-sim/python.bat", str(ROOT / "scripts/diagnose_extraction_v1.py"), "--headless",
