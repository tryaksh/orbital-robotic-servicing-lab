...
def main():
    ...
    for controller in ("deterministic", "stochastic", "retry"):
        ...
        command = ["C:/isaac-sim/python.bat", str(ROOT / "scripts/diagnose_policy_v3.py"), "--headless",
        ...
        manifest = {"schema": 1, "status": "starting", "run_id": args.run_id + "/" + controller,
                    ...
                    "scope": "Reward-v3 control rerun; frozen v2 physical task, script and checkpoint."}
