"""Compare recovery after a fixed action-only insertion prefix, without resets or pose writes."""
...
def main():
    ...
    report = {"status": "starting", "controller": args.controller, "seed": 10070,
               "research_result": False, "reward_version": "completion_credit_v3", "diagnostic_protocol": "failure_prefix_recovery_v1", "training_run_status": "completed", "checkpoint_selection": "Final registered 22-cohort budget checkpoint; no selection by score"}
    app = env = None
    try:
        ...
        report.update(prefix_controls=60, prefix_physics_steps=480, prefix_seconds=4.,
