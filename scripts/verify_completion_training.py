...
def main():
    ...
    for p in args.evaluation:
        ...
        frozen = json.loads((ROOT / "configs/protocol_v3.json").read_text())
    ...
    result["prior_development_costs"] = json.loads((ROOT / "configs/completion_training_registration_v3.json").read_text())["previous_cost_accounting"]
