# Archived record before the mission application

Historical reasoning and results, preserved on 2026-09-14. Status statements
below may be superseded or contradictory. Read [current state](../NOW.md) and
[current tasks](../NEXT_WORK.md) before quoting a result.
