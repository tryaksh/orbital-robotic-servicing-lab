...
| Damage safety | Contact forces are solved by PhysX but are not observed, limited, or reported. There is no peak-force or impulse budget, so nothing here shows the insertion would not bend a connector |
