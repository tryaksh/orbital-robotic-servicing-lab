...
| Nominal point, retention paired | **110/192 (57.29%) without the rack's pawls, 187/192 (97.40%) with them**; 77 gained, 0 lost, p = 1.3e-23. Precision given delivery 0.588 -> 1.000; residual max 5.734 mm -> 1.874 mm; drift after release goes to zero. The five remaining failures are identical in both arms and never left the source bay |
| Module-section axis, with pawls | **The axis is delivery, not seating.** Precision given delivery is 1.000 at every seed of both cross-sections; pass rates 187/192 nominal, 175/192 at 140x26, 152/192 at 120x16 track delivery alone (0.974, 0.911, 0.792). The "not qualified" boundary decision was reading a capture failure as a clearance failure |
