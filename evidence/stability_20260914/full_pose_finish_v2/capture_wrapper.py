...
OUT = Path('D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-v2')
...
hook = '''
        ...
        _portfolio_out = Path("D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-v2")
        _portfolio_bodies = []
...
(OUT / 'capture_provenance.json').write_text(json.dumps({
    ...
    'source_commit': '3d74b6b7bddde41c869b31a2ea27e0ec2b4398a7',
