...
OUT = Path('D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-v4')
...
hook = '''
        ...
        _portfolio_out = Path("D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-v4")
        _portfolio_bodies = []
...
(OUT / 'capture_provenance.json').write_text(json.dumps({
    ...
    'source_commit': '7029ad5cd8d6aa35c803bcd9eb2bd0d0d423fb3e',
