...
OUT = Path('D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-probe')
...
hook = '''
        ...
        _portfolio_out = Path("D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-probe")
        _portfolio_bodies = []
...
(OUT / 'capture_provenance.json').write_text(json.dumps({
    ...
    'source_commit': 'febfca8d19982a12dab434ffc48b306f69e1d813',
