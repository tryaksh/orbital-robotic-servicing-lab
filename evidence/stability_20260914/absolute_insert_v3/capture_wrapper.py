...
OUT = Path('D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-v3')
...
hook = '''
        ...
        _portfolio_out = Path("D:/portfolio/.lab-work/orbital-improvement/smooth-fixed-v3")
        _portfolio_bodies = []
...
(OUT / 'capture_provenance.json').write_text(json.dumps({
    ...
    'source_commit': '1d3714616f60ca6d6e254cc18bac94ca77fc0d7e',
